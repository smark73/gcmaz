...
function gcmaz_event_post_type(){
    $args = array(
            'labels' => array(
                ...
                'menu_name' => __('Event Posts'),
                'all_items' => __('See All'),
                'add_new' => __('Add New'),
                'add_new_item' => __('Add New Event Post'),
                'edit' => __('Edit Post'),
                'edit_item' => __('Edit Event Post'),
                'new_item' => __('New Event Post'),
                'view' => __('View Event Post'),
                'view_item' => __('View Event Post'),
                'search_items' => __('Search Event Posts'),
                'not_found' => __('No Event Posts'),
                'not_found_in_trash' => __('No Event Posts in the trash'),
            ),
            'hierarchichal' => false,
            'public' => true,
            'menu_position' => 5,
            ...
            'description' => "Events for Great Circle Media web listings",
