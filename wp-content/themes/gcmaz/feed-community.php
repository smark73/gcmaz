	...
	<channel>
		...
		<?php do_action( 'rss2_head' ); ?>
            ...
            <?php
                ...
                // query the Community category
                // for position - use start date (community_fulldate)
                // for kill date - use end date (community_fullenddate)
                ...
                ?>
                    ...
                    ?>
                        ...
                        <?php
                            ...
                            $eStartDate = get_post_custom_values('community_date');
                            $eEndDate = get_post_custom_values('community_enddate');
                            ...
                            $content = '<span class="listdate red">' . $eventDate . '</span>' . $content;
