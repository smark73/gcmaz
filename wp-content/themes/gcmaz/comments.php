<?php
 ...
 if (have_comments()) : ?>
  <section id="comments">
    <h4 class="gray"><?php printf(_n('One Response to &ldquo;%2$s&rdquo;', '%1$s Responses to &ldquo;%2$s&rdquo;', get_comments_number(), 'roots'), number_format_i18n(get_comments_number()), get_the_title()); ?></h4>
...
<?php if (comments_open()) : ?>
  <section id="respond">
    <h4 class="gray"><?php comment_form_title(__('Leave a Reply', 'roots'), __('Leave a Reply to %s', 'roots')); ?></h4>
