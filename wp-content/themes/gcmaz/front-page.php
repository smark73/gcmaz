<div class="row"><!-- front-page-->
            ...
            <div id="kaffBlock" class="row">
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <a href="http://kaff.gcmaz.com"><img id="kaffLogo" class="img-responsive" src="/media/flagstaff-radio-kaff-country.jpg" alt="Northern Arizona Radio - KAFF Country 92.9" /></a>
                </div>
            ...
            <div id="kmgnBlock" class="row">
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <a href="http://939themountain.gcmaz.com"><img id="kmgnLogo" class="img-responsive" src="/media/flagstaff-radio-the-mountain.jpg" alt="Northern Arizona Radio - 93.9 The Mountain" /></a>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-6">
            ...
            <div id="kaffamBlock" class="row">
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <a href="http://country935.gcmaz.com"><img id="kaffamLogo" class="img-responsive" src="/media/flagstaff-radio-country-93-5.jpg" alt="Flagstaff Radio Country 93-5" /></a>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-6">
            ...
            <div id="kfszBlock" class="row">
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <a href="http://hits106.gcmaz.com"><img id="kfszLogo" class="img-responsive" src="/media/flagstaff-radio-hits-106.jpg" alt="Flagstaff Radio - Hits 106" /></a>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-6">
            ...
            <div id="ktmgBlock" class="row">
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <a href="http://magic991.gcmaz.com"><img id="ktmgLogo" class="img-responsive" src="/media/prescott-radio-magic.jpg" alt="Prescott Radio - Magic 99.1" /></a>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-6">
