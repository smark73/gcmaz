...
function gcmaz_event_post_type(){
    $args = array(
            'labels' => array(
                'name' => __("Web Listings for all stations 'HAPPENINGS', 'CONCERTS', 'INFO' pages"),
                'singular_name' => __('Web Listing'),
                'menu_name' => __('EVENTS & INFO'),
                'all_items' => __('See All'),
                'add_new' => __('Add New'),
                'add_new_item' => __('Add New Web Listing (Happenings, Concerts, Info)'),
                'edit' => __('Edit Post'),
                'edit_item' => __('Edit Web Listing'),
                'new_item' => __('New Web Listing'),
                'view' => __('View Web Listing'),
                'view_item' => __('View Web Listing'),
                'search_items' => __('Search Web Listings'),
                'not_found' => __('No Web Listings'),
                'not_found_in_trash' => __('No Web Listings in the trash'),
            ),
            'hierarchichal' => false,
            'public' => true,
            'menu_position' => 5,
            ...
            'description' => "Web Listings for all stations 'HAPPENINGS', 'CONCERTS', 'INFO' pages",
